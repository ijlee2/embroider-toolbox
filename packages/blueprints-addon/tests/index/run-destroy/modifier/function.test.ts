...
import {
  inputProject,
  outputProject,
} from '../../../fixtures/run-destroy-modifier/function/index.js';

const fixtureRoot = 'tmp/run-destroy-modifier/function';
...
test('index | run-destroy | modifier > function', function () {
